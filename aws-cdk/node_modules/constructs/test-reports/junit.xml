...
<testsuites name="jest tests" tests="44" failures="0" errors="0" time="4.981">
  <testsuite name="undefined" errors="0" failures="0" skipped="0" timestamp="2020-12-08T05:22:09" time="3.894" tests="43">
    ...
    <testcase classname=" constructs cannot be created with an empty name unless they are root" name=" constructs cannot be created with an empty name unless they are root" time="0.043">
    </testcase>
    ...
    <testcase classname=" if construct id contains path seperators, they will be replaced by double-dash" name=" if construct id contains path seperators, they will be replaced by double-dash" time="0.001">
    </testcase>
    ...
    <testcase classname=" construct.uniqueId (deprecated) returns a tree-unique alphanumeric id of this construct" name=" construct.uniqueId (deprecated) returns a tree-unique alphanumeric id of this construct" time="0.003">
    </testcase>
    <testcase classname=" cannot calculate uniqueId if the construct path is [&quot;Default&quot;]" name=" cannot calculate uniqueId if the construct path is [&quot;Default&quot;]" time="0.018">
    </testcase>
    ...
    <testcase classname=" construct.getContext(key) can be used to read a value from context defined at the root level" name=" construct.getContext(key) can be used to read a value from context defined at the root level" time="0">
    </testcase>
    ...
    <testcase classname=" addMetadata(type, data) can be used to attach metadata to constructs" name=" addMetadata(type, data) can be used to attach metadata to constructs" time="0.002">
    </testcase>
    <testcase classname=" addMetadata(type, undefined/null) is ignored" name=" addMetadata(type, undefined/null) is ignored" time="0.002">
    </testcase>
    ...
    <testcase classname=" addInfo(message) can be used to add an &quot;INFO&quot; message entry to the construct" name=" addInfo(message) can be used to add an &quot;INFO&quot; message entry to the construct" time="0.006">
    </testcase>
    <testcase classname=" multiple children of the same type, with explicit names are welcome" name=" multiple children of the same type, with explicit names are welcome" time="0.001">
    </testcase>
    ...
    <testcase classname="defaultChild returns the child with id &quot;Resource&quot;" name="defaultChild returns the child with id &quot;Resource&quot;" time="0">
    </testcase>
    <testcase classname="defaultChild returns the child with id &quot;Default&quot;" name="defaultChild returns the child with id &quot;Default&quot;" time="0.001">
    </testcase>
  ...
  <testsuite name="undefined" errors="0" failures="0" skipped="0" timestamp="2020-12-08T05:22:13" time="0.191" tests="1">
